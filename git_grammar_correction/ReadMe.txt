...
-Example:
    for evaluating: python inference.py eval models/t5_base_v1.1  -f data/test_data.csv
    for generating: python inference.py gen models/t5_base_v1.1  -s 'i will go home yesterday.'
    for generating: python inference.py gen models/t5_base_v1.1  -f data/test.txt